...
const menuGroups = [
  {
    title: "Menu",
    items: [
      { icon: GridIcon, name: "Dashboard", subItems: [{ name: "Ecommerce", path: "/dashboard", pro: false, new: true }] },
      { icon: CalendarIcon, name: "Calendar", path: "/calendar" },
      { icon: EcommerceIcon, name: "Purchase", path: "/purchases" },
      { icon: EcommerceIcon, name: "Sale", path: "/sales" },          //  매출 관리
      { icon: EcommerceIcon, name: "Inventory", path: "/inventory" }, //  재고 관리
      { icon: EcommerceIcon, name: "Accounting", path: "/accounting"} //  회계 관리
    ],
  },
  {
    title: "Organization",
    items: [
      ...
      { icon: ListIcon, name: "Parties", path: "/parties" },          //  거래처 관리
      { icon: ListIcon, name: "Products", path: "/products" },        //  상품 관리
  ...
  },
  {
    title: "Others",
    items: [
      { icon: ListIcon, name: "Icon Gallery", path: "/icon-gallery" },
    ],
  },
];
