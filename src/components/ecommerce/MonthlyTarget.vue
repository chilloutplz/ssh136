<template>
  <div
    class="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/3"
  >
    <div
...
import DropdownMenu, { type MenuItem } from '../common/DropdownMenu.vue'
...
const value = computed(() => props.value ?? 75.55)

// ── 메뉴 아이템 (DropdownMenu 에서 export 한 타입 그대로 사용) ──
...
// ── 차트 ─────────────────────────────────────────────────────
const series = computed(() => [value.value])
