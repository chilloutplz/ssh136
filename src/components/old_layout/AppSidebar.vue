...
const menuGroups = [
    ...
    items: [
      {
        icon: GridIcon,
        name: "Dashboard",
        subItems: [{ name: "Ecommerce", path: "/dashboard", pro: false, new: true }],
      },
      {
        icon: CalendarIcon,
        name: "Calendar",
  ...
  },
  {
    ...
    items: [
      ...
      //   name: "Charts",
      //   subItems: [
      //     { name: "Line Chart", path: "/line-chart", pro: false, new: true },
      //     { name: "Bar Chart", path: "/bar-chart", pro: false, new: true },
      //   ],
      // },
      // {
      //   icon: BoxCubeIcon,
      //   name: "Ui Elements",
      //   subItems: [
      //     { name: "Alerts", path: "/alerts", pro: false, new: true },
      //     { name: "Avatars", path: "/avatars", pro: false, new: true },
      //     { name: "Badge", path: "/badge", pro: false, new: true },
      //     { name: "Buttons", path: "/buttons", pro: false, new: true },
      //     { name: "Images", path: "/images", pro: false, new: true },
      ...
      //   name: "Authentication",
      //   subItems: [
      //     { name: "Signin", path: "/signin", pro: false, new: true },
      //     { name: "Signup", path: "/signup", pro: false, new: true },
      //   ],
      // },
      // {
      //   icon: UserCircleIcon,
      ...
      //   icon: ListIcon,
      //   subItems: [
      //     { name: "Form Elements", path: "/form-elements", pro: false, new: true },
      //   ],
      // },
      // {
      //   name: "Tables",
      //   icon: TableIcon,
      //   subItems: [{ name: "Basic Tables", path: "/basic-tables", pro: false, new: true }],
      // },
      // {
      //   name: "Pages",
      //   icon: PageIcon,
      //   subItems: [
      //     { name: "Black Page", path: "/blank", pro: false, new: true },
      //     { name: "404 Page", path: "/error-404", pro: false, new: true },
      //   ],
      // },
  ...
  },
  {
    title: "Admin", // ✅ 새 그룹 추가
    items: [
      { icon: ListIcon, name: "Companies", path: "/companies" },
      { icon: ListIcon, name: "Brands", path: "/brands" },
      { icon: ListIcon, name: "Branches", path: "/branches" },
    ],
  },
];
